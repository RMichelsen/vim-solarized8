...
" Last Updated: 9/22/2020 8:33:59 PM
...
if (has('termguicolors') && &termguicolors) || has('gui_running')
  if &background ==# 'dark'
    ...
    if get(g:, 'solarized_visibility', '') ==# 'high'
      hi CursorLineNr guifg=#2aa198 guibg=NONE gui=bold cterm=bold
      hi NonText guifg=#2aa198 guibg=NONE gui=bold cterm=bold
      hi SpecialKey guifg=#2aa198 guibg=NONE gui=reverse cterm=reverse
    ...
    elseif get(g:, 'solarized_visibility', '') ==# 'low'
      ...
      hi SpellLocal guifg=#b58900 guibg=NONE guisp=#b58900 gui=undercurl cterm=underline
      hi SpellRare guifg=#2aa198 guibg=NONE guisp=#2aa198 gui=undercurl cterm=underline
      hi Title guifg=#2aa198 guibg=NONE gui=bold cterm=bold
    endif
    ...
    hi IncSearch guifg=#cb4b16 guibg=NONE gui=reverse cterm=reverse
    ...
    hi PreProc guifg=#2aa198 guibg=NONE gui=NONE cterm=NONE
    hi Special guifg=#2aa198 guibg=NONE gui=NONE cterm=NONE
  ...
  if get(g:, 'solarized_visibility', '') ==# 'high'
    ...
    hi MatchParen guifg=#2aa198 guibg=#eee8d5 gui=bold,underline cterm=bold,underline
...
if s:t_Co >= 256
  if &background ==# 'dark'
    ...
    if get(g:, 'solarized_visibility', '') ==# 'high'
      hi CursorLineNr ctermfg=37 ctermbg=NONE cterm=bold
      hi NonText ctermfg=37 ctermbg=NONE cterm=bold
      hi SpecialKey ctermfg=37 ctermbg=NONE cterm=reverse
    ...
    elseif get(g:, 'solarized_visibility', '') ==# 'low'
      ...
      hi SpellLocal ctermfg=136 ctermbg=NONE cterm=underline
      hi SpellRare ctermfg=37 ctermbg=NONE cterm=underline
      hi Title ctermfg=37 ctermbg=NONE cterm=bold
    endif
    if get(g:, 'solarized_old_cursor_style', 0)
  ...
  if get(g:, 'solarized_visibility', '') ==# 'high'
    ...
    hi MatchParen ctermfg=37 ctermbg=254 cterm=bold,underline
...
if s:t_Co >= 16
  if &background ==# 'dark'
    ...
    if get(g:, 'solarized_visibility', '') ==# 'high'
      ...
      hi SpecialKey ctermfg=6 ctermbg=NONE cterm=reverse
    ...
    hi IncSearch ctermfg=9 ctermbg=NONE cterm=reverse
  ...
  if get(g:, 'solarized_visibility', '') ==# 'high'
    ...
    hi MatchParen ctermfg=6 ctermbg=7 cterm=bold,underline
